...
#include <iostream>
#include <mutex>
class PermissionsService : public sdbus::AdaptorInterfaces<PermissionsServiceAdaptor> {
    public:
        PermissionsService(sdbus::IConnection& connection, sdbus::ObjectPath object);
        ~PermissionsService();
    ...
    protected:
        ...
        void CheckApplicationHasPermission(sdbus::Result<bool>&& result, 
                                                    std::string path, int permission) override;
